...
import { scheduleService, StudySchedule, TimelineEvent } from '../services/scheduleService.js'; // Textbook を削除
import { BookOpen } from 'lucide-react'; // Calendar, Plus, Edit, Trash, Clock を削除
import YearlyActivityCalendar from '../components/YearlyActivityCalendar.js';
import ScheduleProgressChart from '../components/ScheduleProgressChart.js';
import TextbookStackedProgress from '../components/TextbookStackedProgress.js';
import StudyGanttChart from '../components/StudyGanttChartComponent.js';
